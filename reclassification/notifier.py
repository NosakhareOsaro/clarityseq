...
def _get_smtp_config() -> dict:
    ...
    return {
        ...
        "from_addr": os.environ.get(
            "NOTIFICATION_EMAIL_FROM", "genomeforge@nhs.uk"
        ),
        "to_addrs": [
            addr.strip()
...
def _send_slack_message(
    ...
    payload: dict = {
        ...
        "username": "GenomeForge Reclassification Daemon",
        "icon_emoji": ":dna:",
        "text": text,
    }
    if attachments:
...
def send_reclassification_alert(event: ReclassificationEvent) -> None:
    ...
    slack_attachments = [
        {
            ...
            "footer": "GenomeForge Reclassification Daemon | ACGS 2024 §9",
            "ts": int(
    ...
    if is_urgent:
        ...
        by ACGS 2024 §9.</p>
        <hr><p><small>Generated by GenomeForge Reclassification Daemon</small></p>
        </body></html>
        """
        body_text = (
        ...
        attachments=[
            {
                ...
                "text": message_text,
                "footer": "GenomeForge ClinVar Submitter",
            }
        ],
    )
